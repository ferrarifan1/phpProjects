  ...
  if(isset($_POST['register'])){
    ...
    // If forms are blank, alert
     ...
     if($check_email==1){
      ...
      $insert = "insert into register_user (user_name,user_pass,user_email,user_country,user_no,user_address,user_gender,user_b_day,user_image,register_date) values ('$user_name','$user_pass','$user_email','$user_country','$user_no','$user_address','$user_gender','$user_b_day','$register_date', NOW())";
